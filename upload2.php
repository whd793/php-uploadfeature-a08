...
<head>
	<title>Lab 08 - Upload Multiple</title>
...
<body>
<h1 style="font-size:14pt; text-indent:360px;">Lab 08 - Upload Multiple</h1>
...
<form id="form0" method="post" action="doUpload2.php" enctype="multipart/form-data"> 
    <fieldset id="info">
        ...
        <ul>
            ...
            <li> <label title="userfile" for="userfile1">File 1: <span>*</span></label> <input type="file" name="userfile1" id="userfile1" size="25" /></li>
          <li> <label title="userfile" for="userfile2">File 2: <span>*</span></label> <input type="file" name="userfile2" id="userfile2" size="25" /></li>
           <li> <label title="userfile" for="userfile3">File 3: <span>*</span></label> <input type="file" name="userfile3" id="userfile3" size="25" /></li>
          <li> <label title="userfile" for="userfile4">File 4: <span>*</span></label> <input type="file" name="userfile4" id="userfile4" size="25" /></li>
           <li> <label title="userfile" for="userfile5">File 5: <span>*</span></label> <input type="file" name="userfile5" id="userfile5" size="25" /></li>
        </ul>
    </fieldset>
    <fieldset id="submit">
